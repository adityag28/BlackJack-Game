...
let cardBt = document.querySelector("#card-bt"); //Asked for a html element by its id selector.
let cardMsg = document.querySelector("#msg-cn"); //Asked for a html element by its id selector.
let cardSum = document.querySelector("#sum-cn"); //Asked for a html element by its id selector.
...
function renderStart() {
  ...
  cardBt.textContent = "Cards: " + cardOne + " " + cardTwo; //added cardOne & cardTwo values infront of the  card.
  cardSum.textContent = "Sum: " + sum; //added sum value infront of  the  sum.
  if (sum < 20) {
...
function newCard() {
  ...
  let cardThree = 5;
  sum += cardThree;
  renderStart(); // call this card to re-run the code of this function
}
